...
var arrayOfCards = [
  ...
  {name: 'Acquisition Octopus', picture: 'multiverseid=548339&type=card'}, manaCost: '2U', manaValue: 3, cardType: ['Artifact', 'Creature'], type: ['Equipment', 'Octopus'], rulesText: 'Whenever Acquisition Octopus or equipped creature deals combat damage to a player, draw a card.  Reconfigure 2 (2: Attach to target creature you control; or unattach from a creature. Reconfigure only as a sorcery. While attached, this isn't a creature.)', power: 2, toughness: 2, rarity: 'Uncommon', expansion: 'NEO', cardNum: 044, artist: 'Francisco Miyara'},
  ...
  {name: 'Adamant Will', picture: 'multiverseid=540828&type=card', manaCost: '1W', manaValue: 2, cardType: ['Instant'], rulesText: 'Target creature gets +2/+2 and gains indestructible until end of turn. (Damage and effects that say "destroy" don't destroy it.)', rarity: 'Common', expansion: 'VOW', cardNum: 001, artist: 'Irina Nordsol'},
  ...
  {name: 'Adaptive Sporesinger', picture: 'multiverseid=602687&type=card', manaCost: '2G', manaValue: 3, cardType: ['Creature'], type: ['Phyrexian', 'Druid'], rulesText: 'Vigilance  When Adaptive Sporesinger enters the battlefield, choose one —  • Target creature gets +2/+2 and gains vigilance until end of turn.  • Proliferate. (Choose any number of permanents and/or players, then give each another counter of each kind already there.)', power: 2, toughness: 2, rarity: 'Common', expansion: 'ONE', cardNum: 157, artist: 'Dave Kendall'},
